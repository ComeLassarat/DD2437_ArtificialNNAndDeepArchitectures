...
class RestrictedBoltzmannMachine:
    ...
    def cd1(self, visible_trainset, n_iterations=100, plotting=False):
        ...
        for iteration in range(n_iterations):
            results_list = []
            for id_batch in tqdm(range(Nb_batch)): #tqdm initialize a process bar (woula c'est plus classe avec ça)
    ...
    def update_params(self, v_0, h_0, v_k, h_k):
        ...
        # fonction en place ; ne retourne rien et update les paramètres du self seulement 
        return
